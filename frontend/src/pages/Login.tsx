  ...
  return (
      <div className="flex">
          <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-8 md:p-12">
              <form onSubmit={handleSubmit} className="w-full max-w-md bg-white p-8 rounded-lg border border-gray-200 shadow-sm">
                  ...
                  <div className="mb-4">
                      ...
                      <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full p-2 border border-gray-200 rounded"
          ...
          <div className="hidden md:block w-1/2 bg-gray-800">
            ...
            ">
                  <img draggable="false" src={login} alt="Login to Account" className="h-[750px] w-full object-cover"/>
            </div>
          </div>
    </div>
  )
